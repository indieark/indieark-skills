...
SCHEMA_VERSION = 1
ASSET_TYPES = ("character", "scene", "prop", "graphic", "voice")
ASSET_CONTAINERS = {
...
# Voice assets are audio samples; everything else is image-class. The media
# subdirectory only affects where the source file is copied inside the asset.
ASSET_MEDIA_DIRS = {
    "character": "images",
    "scene": "images",
    "prop": "images",
...
class ProjectStore:
    ...
    def create_project(
        ...
        *,
        ...
        data: dict[str, Any] = {
            ...
            "created_at": now,
            "updated_at": now,
            "assets": {container: [] for container in ASSET_CONTAINERS.values()},
            "script": None,
            "style": None,
            "storyboards": [],
            "generations": [],
    ...
    def add_asset(
        ...
        *,
        ...
        prefix = ASSET_ID_PREFIXES[asset_type]
        ...
        media_dir = asset_dir / ASSET_MEDIA_DIRS[asset_type]
    ...
    def _project_snapshot(self, project_id: str, project: dict[str, Any]) -> dict[str, Any]:
        return {
            ...
            "props": project.get("assets", {}).get("props", []),
            "graphics": project.get("assets", {}).get("graphics", []),
            "voices": project.get("assets", {}).get("voices", []),
        }
