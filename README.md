...
[![Skills](https://img.shields.io/badge/skills-8-orange?style=flat-square)](#八件套--active)
[![Active](https://img.shields.io/badge/active-4-brightgreen?style=flat-square)](#八件套--active)
[![Preview](https://img.shields.io/badge/preview-4-yellow?style=flat-square)](#八件套--preview)
...
`active` · `v0.1.0-beta.29` · CLI: `imagen`
...
- **设计 tokens 先行** — `tokens → v0 → full → verify` 四段式
- 覆盖 **landing / dashboard / docs / slides** 多种页面类型模板
- inline React + Babel / CSS tokens / `oklch()` 实施范式齐备
...
- `preview` — `v0.1.0-skeleton`，可被 agent 加载，CLI 与下游链未就位
