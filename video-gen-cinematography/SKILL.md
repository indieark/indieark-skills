...
- `references/input/media/` 与 `references/input/gallery.html` 是示例媒体与人类画廊：md 内引用（webp 用 `![](media/...)`、mp4 用 `<video src="media/...">` 标签）与 gallery.html 同步维护，**改路径必裂图，禁止移动或重命名 media 内文件**。
